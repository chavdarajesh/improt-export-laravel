...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Services /</span> All Services /</span> Edit Service</h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <hr class="my-0" />
                <div class="card-body">
                    <form id="form" method="POST" action="{{ route('admin.services.update') }}"
                        enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <input type="hidden" name="id" value="{{ $Service['id'] }}">
                        <input type="hidden" name="old_image" value="{{ $Service['image'] }}" id="old_image">
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" rows="5" type="text"
                                    id="description" name="description" value="">{!! $Service['description'] !!}</textarea>
