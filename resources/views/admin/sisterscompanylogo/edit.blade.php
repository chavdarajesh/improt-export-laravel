...
@section('title', 'Edit SistersCompanyLogo')
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <h5 class="card-header">Edit SistersCompanyLogo</h5>
                    <!-- Account -->
                    <hr class="my-0" />
                    <div class="card-body">
                        <form id="form" method="POST" action="{{ route('admin.sisterscompanylogo.update') }}"
                            enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <input type="hidden" name="id" value="{{ $SistersCompanyLogo['id'] }}">
                            <input type="hidden" name="old_image" value="{{ $SistersCompanyLogo['image'] }}" id="old_image">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-12">
                                    ...
                                    <input class="form-control @error('name') is-invalid @enderror" type="text"
                                        id="name" name="name" value="{{ $SistersCompanyLogo['name'] }}" autofocus />
